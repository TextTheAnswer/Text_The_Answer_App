...
class LibraryAchievementsPage extends StatefulWidget {
  const LibraryAchievementsPage({super.key});

  @override
  State<LibraryAchievementsPage> createState() =>
      _LibraryAchievementsPageState();
}

class _LibraryAchievementsPageState extends State<LibraryAchievementsPage>
      ...
      body: BlocListener<AchievementBloc, AchievementState>(
        ...
        child: TabBarView(
          ...
          children: [
            ...
            LibraryGameHistory(gameHistorys: mockGameHistory),
          ],
        ),
      ),
    );
        ...
        if (state is AchievementLoading) {
          ...
          if (achievements.isEmpty) {
            return EmptyStateContainer(
              ...
              subtitle: 'Check back later to see achievements.',
  ...
  Widget _buildCompletedAchievementsTab() {
    return BlocBuilder<AchievementBloc, AchievementState>(
      builder: (context, state) {
        ...
        return EmptyStateContainer(
          title: 'No achievements found',
          subtitle: 'Check back later to see your achievements.',
          icon: Icons.error_outline,
        );
      },
    );
  ...
  Widget _buildCompletedAchievementsView(
      ...
      children:
          tiers.map((tier) {
            return _buildTierSection(
              title:
                  '${tier.substring(0, 1).toUpperCase()}${tier.substring(1)} Achievements',
  ...
  Widget _buildAchievementCard(Achievement achievement) {
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(color: _getTierColor(achievement.tier), width: 1),
      ),
      child: InkWell(
  ...
  void _showAchievementDetailsDialog(
